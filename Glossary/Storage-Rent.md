...
[^1]: -	EIP 27 is extending Ergo's original 8 year emission schedule via soft-fork. This EIP passed with over 90% miner support and was implemented live on block #777,217 (June 21, 2022) . Anyone interested can review the origianl community discussion here: [Ergo Emission: details, retargeting via a soft-fork](https://www.ergoforum.org/t/ergo-emission-details-retargeting-via-a-soft-fork/2778/21) and read this [blog post](https://ergoplatform.org/en/blog/A-New-Era-for-Ergo-EIP-27-Begins-Today/) for a good proposal summary.
