...
Ergo 應該要盡可能去中心化。一律盡力以分散的方式成長。任一方的社群領導者、軟體開發人員、硬體製造商、礦工及資金，都必須避免出現集中式的失敗點。如果某個執行者在其不存在的情況下會干擾系統的運作，該執行者便應該為干擾事件規劃緊急應變計畫。去中心化是源自教育和採用，因此我們所建置的工具需要文件，而社群也必須主動參與及成長。我們必須教導彼此如何使用及採用這些工具。網際網路是去中心化的強大驅力，且可以成為強大的教育工具。無論是開發端還是使用者端，去中心化都是以教育為本。
