...
- [Hindi]([ghoshanapatra](/hi-in/ghoshanapatra)) PS: remove 'en' from URL to fix broken link, bug. Or go home, select hindi from language menu and then navigate to Manifesto
