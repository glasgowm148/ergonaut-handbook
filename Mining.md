...
Miners have to perform memory-hard computations which makes Ergo friendly for GPU mining. To mine Ergo today ~3 GB memory is needed,  but the most efficient implementation currently utilizes ~4 GB of vRAM. 
...
>
>EIP-27 showcases the chains ability to amend itself/evolve, in a decentralized fashion. Similar to EIP-27, *most* future protocol changes are expected to occur painlessly, via soft and velvet forks. 
{.is-info}
