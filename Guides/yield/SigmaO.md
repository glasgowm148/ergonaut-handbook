...
- [WATCH: Options Trading on Ergo | One Take Series](https://youtube.com/watch?v=XoJT7aR7o4w): Join qx() as he takes you through a one shot no edits no nonsense take on how to do options trading on Ergo! This is only for buying call options, more videos to come with how to execute the call, and create calls and puts. 
